    ...
    <body>
        <section class="flex flex-col items-center space-y-4 py-12">
            ...
            <form class="p-4 w-1/4">
                ...
                <button type="submit" class="bg-teal-500 text-black font-bold w-full rounded shadow p-2">Guardar</button>
            </form>

            <table class="shadow-md w-1/3">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm">
                        <th class="py-3 px-6 text-left text-center">Hecha</th>
                ...
                <tbody class="text-gray-600">
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="px-4 py-2 text-center">
                            <button type="button" class="bg-yellow-400 px-2 py-1 text-black text-xs rounded">Editar</button>
